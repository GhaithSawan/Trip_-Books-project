...
// function handelCreateStrip() {
//   axios(`${URL}/StripRouts/CreateStrip`, {
//     "name": "req.body.name",
//     "duration": 2,
...
//     const checkInDate = new Date(Check_In).toISOString();
//     const checkOutDate = new Date(Check_Out).toISOString();

//     axios.get(`${URLaxios}/StripRouts/GetAllStrips?Destination=${Destination}`).then((res) => {
//       let filteredData = res?.data?.filter((e) => {
//         const createdAt = new Date(e.createdAt).toISOString();
//         const expiresAt = new Date(e.expiresAt).toISOString();
...
//         </div>
//       </div>
//       <StripsModel show={show} setShow={setShow} Strips={Strips} />
//     </Slide>
//   );
// };
